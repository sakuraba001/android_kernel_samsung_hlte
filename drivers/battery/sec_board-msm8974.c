...
static struct battery_data_t samsung_battery_data[] = {
	/* SDI battery data (High voltage 4.35V) */
	{
		...
		.temp_cohot = -1025,
		.temp_cocold = -3675,
#elif defined(CONFIG_MACH_HLTEKDI) || defined(CONFIG_MACH_HLTEEUR)
		.RCOMP0 = 0x73,
		.RCOMP_charging = 0x84,
		.temp_cohot = -1025,
		.temp_cocold = -3675,
...
#elif defined(CONFIG_SEC_H_PROJECT) || defined(CONFIG_SEC_JS_PROJECT) || defined(CONFIG_SEC_KS01_PROJECT)
